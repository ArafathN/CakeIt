...
class CakesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cake" do
    assert_difference('Cake.count') do
      post cakes_url, params: { cake: { author: @cake.author, availability: @cake.availability, description: @cake.description, name: @cake.name, price: @cake.price } }
    end
  ...
  test "should update cake" do
    patch cake_url(@cake), params: { cake: { author: @cake.author, availability: @cake.availability, description: @cake.description, name: @cake.name, price: @cake.price } }
